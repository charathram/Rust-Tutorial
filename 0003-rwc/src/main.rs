// Starting point for Lesson 3: the finished rwc from Lesson 2 (error handling).
// You will make the counting testable, then add a test suite that `cargo test` runs.
use std::env;
use std::fs;
use std::error::Error;
